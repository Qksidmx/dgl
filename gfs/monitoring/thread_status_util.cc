...
namespace skg {
    ...
    void ThreadStatusUtil::NewColumnFamilyInfo(const SkgDB* db,
    ...
    void ThreadStatusUtil::EraseDatabaseInfo(const SkgDB* db) {
        ThreadStatusUpdater* thread_updater = nullptr; // TODO need this interface? db->GetEnv()->GetThreadStatusUpdater();
