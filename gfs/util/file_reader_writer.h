#ifndef STARKNOWLEDGEGRAPHDATABASE_FILE_READER_WRITER_H
#define STARKNOWLEDGEGRAPHDATABASE_FILE_READER_WRITER_H
#include <atomic>
#include <string>
...
#endif //STARKNOWLEDGEGRAPHDATABASE_FILE_READER_WRITER_H
