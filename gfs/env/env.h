...
#ifndef STARKNOWLEDGEGRAPH_ENV_H
#define STARKNOWLEDGEGRAPH_ENV_H
...
namespace skg {
    ...
    public:
        ...
        // Creating.
        // if parent==true, no error if existing, make parent directories as needed
        virtual Status CreateDirIfMissing(const std::string &dirname, bool parent=false) = 0;

        // Delete the specified directory.
        virtual Status DeleteDir(const std::string &dirname, bool recursive=false, bool verbose=false) = 0;
...
// A file abstraction for randomly reading the contents of a file.
    ...
    public:
        ...
        Status CreateDirIfMissing(const std::string& d, bool p) override {
            return target_->CreateDirIfMissing(d, p);
        }
        Status DeleteDir(const std::string& d, bool r, bool v) override {
            return target_->DeleteDir(d, r, v);
        }
...
#endif //STARKNOWLEDGEGRAPH_ENV_H
